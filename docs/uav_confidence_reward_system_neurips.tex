...
RGB+thermal experiments. In the current calibration step this mode uses the
same probability factors as \texttt{rgb}; thermal-specific contrast and smoke
penetration terms are deferred to a separate calibration.
