...
\[
    ...
    =
    \min(1,\;1.30\,q_{\mathrm{environment}}^{\mathrm{RGB}}),
\]
...
to a separate calibration. The environment boost is a conservative proxy for
RGB/thermal camouflage and background gains, referencing arXiv:2203.04567 and
