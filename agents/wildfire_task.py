...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "land_cover_fire_fuel": (0.05, 0.40, 1.10, 1.35, 0.0),
    "object_fire_fuel": (0.0, 0.25, 1.00),
    "wind_direction":   (1, 0),
    "wind_strength":     0.06,
    "terrain_brush_patches": 4,
    "terrain_forest_patches": 3,
    "terrain_rock_patches": 2,
    "terrain_patch_radius":  3,
    "terrain_hills":         4,
    "terrain_elevation_scale": 0.30,
    "terrain_road_width":    1,
    "terrain_house_footprint": 2,
    "max_ground_slope":    0.70,
    "slope_cost_weight":    2.0,
    "slope_speed_weight":   1.5,
    "terrain_path_samples":   6,
    "land_cover_costs": (0.65, 1.0, 1.5, 2.2, 4.0),
    "land_cover_speeds": (1.0, 0.9, 0.65, 0.45, 0.0),
    "terrain_houses":      5,
    "tree_height_range": (0.12, 0.24),
    "house_height_range": (0.08, 0.15),
